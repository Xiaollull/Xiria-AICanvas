...
async function scanFlux2Root(directory, role, relativeDirectory = "", readHeader = readDiffusionModelHeader) {
  let entries;
  try {
...
export async function discoverFlux2Models(roots, readHeader = readDiffusionModelHeader) {
